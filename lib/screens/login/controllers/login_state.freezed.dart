...
abstract class $LoginStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isLoggedIn, ViewState viewState});
...
class _$LoginStateImpl implements _LoginState {
  _$LoginStateImpl({this.isLoggedIn = false, required this.viewState});
  ...
  @override
  String toString() {
    return 'LoginState(isLoggedIn: $isLoggedIn, viewState: $viewState)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, isLoggedIn, viewState);
...
abstract class _LoginState implements LoginState {
  factory _LoginState(
      {final bool isLoggedIn,
      required final ViewState viewState}) = _$LoginStateImpl;
